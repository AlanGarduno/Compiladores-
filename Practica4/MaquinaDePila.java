...
public class MaquinaDePila {
    ...
    private void sumar(){
        ...
        if(v1 instanceof Vector && v2 instanceof Vector)
            pila.push(Operacion.suma((Vector)v1, (Vector)v2));
        else 
            pila.push((double)v1 + (double)v2);
    }
    ...
    private void restar(){
        ...
        Object v1 = pila.pop();
        if(v1 instanceof Vector && v2 instanceof Vector)
            pila.push(Operacion.resta((Vector)v1, (Vector)v2));
        else 
            pila.push((double)v1 - (double)v2);
    }

    private void productoCruz(){
        Object v2 = pila.pop();
        Object v1 = pila.pop();
        if(v1 instanceof Vector && v2 instanceof Vector)
            pila.push(Operacion.productoCruz((Vector)v1, (Vector)v2));
        else 
            pila.push((double)v1 * (double)v2);
    }
    
	private void productoPunto(){
        Object v2 = pila.pop();
        Object v1 = pila.pop();
        if(v1 instanceof Vector && v2 instanceof Vector)
            pila.push(Operacion.productoPunto((Vector)v1, (Vector)v2));
        else 
            pila.push((double)v1 * (double)v2);
    }
    ...
    private void productoEscalar(){
        Object v2 = pila.pop();
        Object v1 = pila.pop();
        if( v1 instanceof Double && v2 instanceof Vector ) 
            pila.push(Operacion.productoEscalar((double)v1, (Vector)v2));
        else if ( v1 instanceof Vector && v2 instanceof Double )
        	pila.push(Operacion.productoEscalar((double)v2, (Vector)v1));
        else 
            pila.push((double)v1 * (double)v2);
    }
	...
	private void norma(){
		...
		if(v1 instanceof Vector )
			pila.push(Operacion.norma((Vector)v1));
		else
			pila.push((double)v1);
	}
    ...
    private void comparar(){
        ...
        if((A instanceof Vector) && (B instanceof Vector))
            pila.push(Operacion.comparar((Vector)A, (Vector)B));
        else
    ...
    private void menor(){
        ...
        if((A instanceof Vector) && (B instanceof Vector)){
            a = Operacion.sumaDeComponentes((Vector)A);
            b = Operacion.sumaDeComponentes((Vector)B);
        }            
        else{
            a = (double)A;
            b = (double)B;
    ...
    public static class Sumar implements Funcion{
        ...
        @Override
        public Object ejecutar(Object A) {
            return Operacion.sumaDeComponentes((Vector)A);
        }
